...
const endpoint = "http(s)://gateway.marvel.com/v1/public/characters"
...
export default class SearchBar extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      heroInfo: {
        ...
        "etag": "c118232d8cc7746db3e6cf7a1bb9d029b1dc7a65",
        "data": {
          "offset": 0,
          "limit": 20,
          "total": 1,
  ...
  handleSubmit(e) {
    ...
    console.log(`${endpoint}?name=${name}&apikey=${apikey}`);

    // query = fetch("https://gateway.marvel.com:443/v1/public/characters?name=Thor&apikey=9d919d14053c4677a44d43af4024d3d1")
